...
//        
////        self.ref.child("UserMessage").child("\(self.currentUser!.id)").child(self.otherUserId).getData { (error, snapshot) in
////
////          //  self.newMessage()
////
...
////        }
//        
//        self.ref.child("UserMessage").child("\(self.currentUser!.id)").child(self.otherUserId).queryOrderedByKey().observe(.value) { (snapshot) in
//            
//            if  let dictResponse:[String:Any] = snapshot.value as? [String : Any]{
//
//print("- Full chat order - 1 ")
//                print(dictResponse)
//
//            
//        }
...
//        
//        
//        self.ref.child("UserMessage").child("\(self.currentUser!.id)").child(self.otherUserId).observe(.value) { (snapshot) in
//
//
//
//
...
//
//                var totalUserKeysInchat = Array(dictResponse.keys)
//                
//                
//                totalUserKeysInchat.sort { (a, b) -> Bool in
//                    return a > b
//                }
//                
//                print(totalUserKeysInchat)
...
//        
//        
////        var dictRequest:[String:Any] = message.dictionary
//        
////        dictRequest["epoch_time"] = Int64(Date().timeIntervalSince1970 * 1000.0)
//        
//       // print("Input parameter - \(dictRequest)")
//        
